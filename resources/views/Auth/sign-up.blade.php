...
<div class="login">
  <div class="login-page">
    ...
    <p>Create your account with Supply Me to continue. </p>
      ...
      @endif
    <form action="{{Route('auth.CreateAccount')}}" enctype="multipart/form-data" method="POST">
      @csrf
      ...
      <span class="signup-text">Don't have an account? <a href="{{Route('auth.loginShow')}}"> Login</a></span>
    </form>
  </div>
</div>
@endsection