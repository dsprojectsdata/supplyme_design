                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <p style="font-size: 16px">
                                        ...
                                        {{ $company->city_id ? ($company->City ? $company->City->name : ' ') : ''}},
                                ...
                                <div class="col-md-3 mb-3">
                                    <p class="text-muted font-weight-bold mb-1">Company Email</p>
                                    <p style="font-size: 16px">
                                        {{$company ? $company->company_email : ' '}}
                                    </p>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
													...
													<label class="custom-switch">
														<input type="checkbox" name="custom-switch-checkbox" onclick="statusTeamMember(this,{{$teamMember->id}})" value="0" class="custom-switch-input"> 
														<span class="custom-switch-indicator" style="background-color:red;"></span>
													</label>
													@else
													<label class="custom-switch">
														<input type="checkbox" name="custom-switch-checkbox" onclick="statusTeamMember(this,{{$teamMember->id}})" value="1" class="custom-switch-input" checked > 
...
<style>
    ...
    <script type="text/javascript">
        function claimed_status(thiss, id) {
            ...
            var ok = confirm("Do you want to " + claimed_status + " the company ? ");
            if (ok == true) {
