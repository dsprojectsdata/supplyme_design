    ...
    <div class="container">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Industries</h2>
                    <ol class="breadcrumb">
            ...
            <div class="row row-sm">
                <div class="col-12 col-lg-6">
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('company.industriesSave', $single_info->slug) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label class="col-sm-12 col-form-label">Name</label>
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="name" placeholder="Enter name" value="{{ old('name', $single_info->industry) }}">
                                        @error('name')
                                ...
                                <table id="example3" class="table table-striped table-bordered text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $single->industry }} </td>
                                            <td>
                                                <a href="{{ route('company.getStoreIndustries', $single->slug) }}" class="ti ti-pencil"></a>
...
<div class="modal" id="modaldemo1">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
            <form action="#" method="POST" id="deleteForm" data-action="{{ route('company.industriesDelete', ':slug') }}">
                @csrf
                ...
                <div class="modal-body">
                    <h6>Industries</h6>
                    <p>Industries data will be Delete forever if you click delete button </p>
                </div>
