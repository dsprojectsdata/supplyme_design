            ...
            <div class="row row-sm">
                <div class="col-12 col-lg-6">
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('company.currenciesSave', $single_info->slug) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label class="col-sm-12 col-form-label">Name</label>
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="name" placeholder="Enter name" value="{{ old('name', $single_info->name) }}">
                                        @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="code" placeholder="Enter code" value="{{ old('code', $single_info->code) }}">
                                        @error('code')
                                        <div class="form-valid-error">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="symbol" placeholder="Enter symbol" value="{{ old('symbol', $single_info->symbol) }}">
                                        @error('symbol')
                                        <div class="form-valid-error">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <table id="example3" class="table table-striped table-bordered text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $single->symbol }} </td>
                                            <td>
                                                <a href="{{ route('company.getStoreCurrencies', $single->slug) }}" class="ti ti-pencil"></a>
...
<div class="modal" id="modaldemo1">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
            <form action="#" method="POST" id="deleteForm" data-action="{{ route('company.currenciesDelete', ':slug') }}">
                @csrf
                ...
                <div class="modal-body">
                    <h6>Currencies</h6>
                    <p>Currencies data will be Delete forever if you click delete button </p>
                </div>
