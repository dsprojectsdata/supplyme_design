...
<style>
    ...
    <div class="login claim-list">
      <div class="login-page">
        ...
        <form action="{{Route('auth.sign_in.invite-member')}}" enctype="multipart/form-data" method="POST"  class="my-4" id="passwordform">
           @csrf
           <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <div class="input-wrapper">
                ...
                <input type="hidden" name="token" value="{{$validToken->token}}">
              </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <div class="input-wrapper">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="input-wrapper">
                <b>Primary Email <span style=" color: red;"> *</span></b>
                    <input type="text" name="email"  value="{{$getEmail}}" placeholder="Enter Email" required onkeyup="validateEmail(this.value)">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="input-wrapper">
                <b>How will you primarily use our network?</b>
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-lg-4 col-xs-4">
                        <input type="radio" id="asBuyerRadioBtn" name="Primary_Use_our_network_for" value="As buyer" required> <span id="buyerSpan"> As Buyer</span>
                    </div>
                    <div class="col-md-4 col-sm-4 col-lg-4 col-xs-4">
                        <input type="radio" id="asSupplierRadioBtn" name="Primary_Use_our_network_for" value="As supplier" required> <span id="supplierSpan"> As Supplier</span>
                    </div>
                </div>
              </div>
            </div>
            ...
            <div class="input-wrapper search-input">
              <button class="btn btn-primary w100">Create Account</button>
            </div>
          </div>
...
function updateValidationInfo(element, isValid) {
    if (isValid) {
        element.removeClass("validation-message").addClass("valid-message");
      
    } else {
        element.removeClass("valid-message").addClass("validation-message");
