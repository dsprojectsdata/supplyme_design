...
<div class="main-content px-md-4 px-2 py-4" style="margin-top:57px">
    ...
    <div class="d-block flex-wrap gap-3 welcomeBox">
        ...
        <div class="row">
            <div class="col-12 col-md-5 col-xl-3 mb-3 mb-md-0" style="">
                <div class="border bg-white compnay-tabs-ul" style="border-color:#B4B6BD; margin-top: 22px ;overflow-y: auto; max-height:400px; padding-right: 2px;">
                    <div class="tabs-ac">
                ...
                <div class="btn-networl my-2">
                    <a href="{{route('admin.supplier.group.create')}}" class="btn btn-primary" style="margin-left: 15px">Create Supplier </a>
                </div>
            </div>
            <div class="col-12 col-md-7 col-xl-9" style="overflow-y: auto; max-height: 550px; padding-right: 2px;">
...
<script>
    ...
    var url ="{{Route('save.buyer_info_Supplier')}}";
      $.ajax({
          url: url, 
          method:"GET",
...
<script>
    ...
    $(document).ready(function() {
        $('body').on('click', '#saveNameGroup', function() {
            ...
            $.ajax({
                url: "{{route('save.save_group_infoSupplier')}}",
                method: 'POST',
                data: {
                    group_id: group_id,
...
<script>
    ...
    function deleteSupplier(group_id, supplier_id) {
        if (confirm("Are you sure you want to delete this supplier?")) {
            $.ajax({
                url: "{{ route('save.deleteSupplierTeamMember_Supplier') }}",
                type: 'DELETE',
                headers: {
